...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-light tracking-wide mb-3 text-gray-800 relative inline-block">
                <span class="relative z-10">Client <span class="font-semibold" style="color: #E1BD84;">Reviews</span></span>
                <span class="absolute -bottom-2 left-0 w-full h-1 bg-opacity-40" style="background-color: #E1BD84;"></span>
            </h2>
            <p class="text-gray-600 max-w-2xl mx-auto mt-4 italic text-lg font-light leading-relaxed">
                Discover what our clients say about their experience with our products and treatments
            </p>
        </div>
        ...
        <div class="text-center mt-12">
            <a href="/testimonials" class="inline-block px-10 py-3 text-white font-medium rounded-md shadow-md hover:shadow-lg transition-colors tracking-wider" style="background-color: #E1BD84; hover:background-color: #c8a66f;">
                READ MORE REVIEWS
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-block ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
